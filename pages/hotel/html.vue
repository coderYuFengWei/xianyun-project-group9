<template>
  <div class="container">
    ...
    <el-row style="padding:20px 0 50px;">
      <el-row>
        <h2>好来阁商务宾馆</h2>
        <i class="iconfont icon-huiyuanhuangguanguanjun" style="color:#f90"></i>
        <i class="iconfont icon-huiyuanhuangguanguanjun" style="color:#f90"></i>
        <i class="iconfont icon-huiyuanhuangguanguanjun" style="color:#f90"></i>
        <i class="iconfont icon-huiyuanhuangguanguanjun" style="color:#f90"></i>
        <i class="iconfont icon-huiyuanhuangguanguanjun" style="color:#f90"></i>
      ...
      <p>
        <i class="iconfont icon-htmal5icon14" style="font-size:25px;"></i>高淳县淳溪镇镇兴路118号(高淳县委党校对面)
      </p>
    </el-row>
    ...
    <el-row :gutter="20">
      <el-col :span="16">
        <el-image
          style="width: 780px; height: 368px;"
          src="http://157.122.54.189:9093/images/hotel-pics/1.jpeg"
        ></el-image>
      </el-col>
      <el-col :span="8">
        <el-image
          style="width: 160px; height: 110.5px; padding:0 10px 15px"
          src="http://157.122.54.189:9093/images/hotel-pics/1.jpeg"
        ></el-image>
        <el-image
          style="width: 160px; height: 110.5px; padding:0 10px 15px"
    ...
    <el-row style="padding:40px 0;">
      <el-table :data="tableData" style="width: 100%">
        <el-table-column prop="date" label="价格来源" width="440"></el-table-column>
        <el-table-column prop="name" label="低价房型" width="440"></el-table-column>
        <el-table-column prop="address" label="最低价格/每间"></el-table-column>
      </el-table>
    </el-row>

    <!--地图组件-->
    <el-row style="hight:100px"></el-row>
    ...
    <el-row class="assest">
      ...
      <el-col :span="20">外币兑换服务电梯洗衣服务热水壶</el-col>
    </el-row>
